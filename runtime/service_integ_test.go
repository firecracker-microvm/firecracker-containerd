...
func newFCClient(path string) (fccontrol.FirecrackerService, error) {
	client, err := ttrpcutil.NewClient(path + ".ttrpc")
	if err != nil {
		return nil, err
	}
	...
	return fccontrol.NewFirecrackerClient(ttrpcClient), nil
}
